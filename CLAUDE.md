# MicrobiomeKG — Claude Code Conventions
...
| `graph/*.kgl` → `../MicrobiomeKG-Data/graph/` | 47 MB (213 MB with `--with-vectors`) | one file plus its `.build.json` census, overwritten per build | the build |
