...
METABOLITE_COLUMNS_V1 = [
    ...
    "moldb_average_mass",
    "moldb_mono_mass",
    "moldb_alogps_solubility",
    "moldb_alogps_logp",
    "moldb_alogps_logs",
    "moldb_acceptor_count",
    "moldb_donor_count",
    "moldb_rotatable_bond_count",
    "moldb_polar_surface_area",
    "moldb_refractivity",
    "moldb_polarizability",
    "moldb_traditional_iupac",
    "moldb_formal_charge",
    "moldb_physiological_charge",
    "moldb_pka_strongest_acidic",
    "moldb_pka_strongest_basic",
    "created_at",
    "updated_at",
    "hmdb_id",
    "detected",
...
METABOLITES: list[dict[str, str]] = [
    {
        "id": "1",
        "name": "Pectin",
        "mime_id": "MMDBc0000239",
        "moldb_inchikey": "PECTINKEY000001-UHFFFAOYSA-N",
        "moldb_formula": "C6H10O7",
        "moldb_average_mass": "194.1394",
        "classification": "Organooxygen compounds",
        "vmh_id": "pect",
        "microbe_relations": "67",
    },
    {
        "id": "2",
        "name": "Chitin",
        "mime_id": "MMDBc0000235",
        "moldb_inchikey": "CHITINKEY00001-UHFFFAOYSA-N",
        "moldb_formula": "C8H13NO5",
        "hmdb_id": "HMDB0003362",
        "vmh_id": "chtn; M01437; M01436",
        "epa_substance_id": "DTXSID801100881",
        "epa_compound_id": "DTXCID201532583",
        "microbe_relations": "36",
    },
    {
        "id": "3",
        "name": "Butyrate salt",
        "mime_id": "MMDBc0000011",
        "hmdb_id": "HMDB00011",
        "detected": "1",
        "quantified": "1",
        "moldb_inchikey": "FERIUCNNQQJTOY-UHFFFAOYSA-M",
        "moldb_formula": "C4H7O2",
        "vmh_id": "but",
        "epa_substance_id": "DTXSID8021515",
        "epa_compound_id": "DTXCID401515",
        "microbe_relations": "778",
    },
    {
        "id": "4",
        "name": "Acetic acid",
        "mime_id": "MMDBc0000012",
        "metabolite_type": "Primary",
        "moldb_inchikey": "MIMEDBACETIC01-UHFFFAOYSA-N",
        "moldb_formula": "C2H4O2",
        "vmh_id": "ac",
        "epa_substance_id": "DTXSID5024394",
        "epa_compound_id": "DTXCID304394",
        "microbe_relations": "2537",
    },
    {
        "id": "5",
        "name": "Ethanoic acid",
        "mime_id": "MMDBc0000013",
        "metabolite_type": "Co-metabolite",
        "moldb_inchikey": "KEY-0012-N",
        "moldb_formula": "C2H4O2",
        "microbe_relations": "0",
    },
    {
        "id": "6",
        "name": "L-Tyrosine",
        "mime_id": "MMDBc0000158",
        "hmdb_id": "HMDB0000158",
        "metabolite_type": "Co-metabolite",
        "moldb_inchikey": "OUYCCCASQSFEME-QMMMGPOBSA-N",
        "moldb_formula": "C9H11NO3",
        "vmh_id": "tyr_L",
        "epa_substance_id": "DTXSID1023730",
        "epa_compound_id": "DTXCID603730",
        "microbe_relations": "1743",
    },
    ...
    # contested and therefore refused as a join key.
    {
        "id": "7",
        "name": "D-Tyrosine",
        "mime_id": "MMDBc0000159",
        "hmdb_id": "HMDB00158",
        "metabolite_type": "Co-metabolite",
        "moldb_inchikey": "OUYCCCASQSFEME-MRVPVSSYSA-N",
        "moldb_formula": "C9H11NO3",
        "epa_substance_id": "DTXSID50883441",
        "epa_compound_id": "DTXCID601022972",
        "microbe_relations": "4",
    },
    {
        "id": "8",
        "name": "Trimethylamine oxide",
        "mime_id": "MMDBc0000014",
        "detected": "1",
        "quantified": "1",
        "moldb_inchikey": "UYPYRKYUKCHHIB-UHFFFAOYSA-N",
        "moldb_formula": "C3H9NO",
        "cas": "1184-78-7",
        "vmh_id": "M03054; tmao",
        "epa_substance_id": "DTXSID8049678",
        "epa_compound_id": "DTXCID5029637",
        "microbe_relations": "146",
    },
    {
        "id": "9",
        "name": "Microbial co-metabolite",
        "mime_id": "MMDBc0000015",
        "metabolite_type": "Co-metabolite",
        "moldb_inchikey": "COMETABOLITE01-UHFFFAOYSA-N",
        "moldb_formula": "C7H6O2",
        "microbe_relations": "1",
    },
    {
        "id": "10",
        "name": "PC(16:0/18:1)",
        "mime_id": "MMDBc0049000",
    ...
    {
        "id": "11",
        "name": "NULL-valued compound",
        "mime_id": "MMDBc0000016",
        "metabolite_type": "Primary",
...
METABOLITES_V2_ONLY: list[dict[str, str]] = [
    {
        "id": "12",
        "name": "Conjugated deoxycholate",
        "mime_id": "MMDBc0060001",
        "detected": "1",
        "quantified": "1",
        "moldb_inchikey": "CONJDEOXYCHOL1-UHFFFAOYSA-N",
        "moldb_formula": "C26H43NO5",
        "cmmc_inchikey": "KEY-0016-N",
        "microbe_relations": "5",
...
MICROBES_V2_ONLY: list[dict[str, str]] = [
    ...
    {
        "id": "8",
        "name": "Aureobasidium pullulans R106",
        "microbe_id": "MMDBm0000008",
...
def main() -> None:
    ...
    write(
        OUT / "mimedb_metabolites_v2.csv",
        METABOLITE_COLUMNS_V2,
        METABOLITES + METABOLITES_V2_ONLY,
    )
    write(
        OUT / "mimedb_microbes_v2.csv", MICROBE_COLUMNS_V2, MICROBES + MICROBES_V2_ONLY
    )
