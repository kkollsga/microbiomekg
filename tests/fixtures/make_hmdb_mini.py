...
RECORDS: list[dict] = [
    dict(
        ...
        accession="HMDB0000011", name="Butyric acid", status="quantified",
        chebi="17968", kegg="C00246", pubchem="264",
        biospecimens=["Blood", "Feces", "Urine"], origins=["Endogenous", "Food"],
        microbes={"Faecalibacterium": ["Faecalibacterium prausnitzii"],
                  "Roseburia": []},
    ...
    dict(
        ...
        accession="HMDB0000012", name="Acetic acid", status="detected",
        chebi="30089", kegg="C00033", pubchem="176",
        biospecimens=["Blood", "Feces"], origins=["Endogenous"],
    ...
    dict(
        ...
        accession="HMDB0000013", name="Trimethylamine N-oxide", status="expected",
        chebi="15724", kegg="C01104", pubchem="1145",
        biospecimens=["Blood", "Urine"], origins=["Endogenous"],
    ...
    dict(
        ...
        accession="HMDB0000014", name="Triclosan", status="predicted",
        chebi="164200", kegg="", pubchem="5564",
        biospecimens=[], origins=["Synthetic"], microbes={},
    ...
    dict(
        ...
        accession="HMDB0000015", name="Skatole", status="expected",
        chebi="9169", kegg="C08313", pubchem="6736",
        biospecimens=["Feces"], origins=["Food"], microbes={},
    ),
    dict(
        why="reactome-chebi only: predicted, never in feces, but ChEBI2Reactome "
            "maps its id — the third selection rule, on its own",
        accession="HMDB0000016", name="Deoxycholic acid", status="predicted",
        chebi="28834", kegg="C04483", pubchem="222528",
        biospecimens=["Blood"], origins=["Endogenous"], microbes={},
    ),
    dict(
        why="the U+FB01 ligature typo: a distinct string from Bifidobacterium "
            "that names.dmp cannot match",
        accession="HMDB0000017", name="Propionic acid", status="quantified",
        chebi="17272", kegg="C00163", pubchem="1032",
        biospecimens=["Feces"], origins=["Endogenous"],
    ...
    dict(
        ...
        accession="HMDB0000018", name="Succinic acid", status="quantified",
        chebi="15741", kegg="C00042", pubchem="1110",
        biospecimens=["Feces", "Blood"], origins=["Endogenous"],
        microbes={"Bacillota": [], "Firmicutes": [], "Human gut microbiota": [],
    ...
    dict(
        ...
        accession="HMDB0000019", name="Indole-3-acetic acid", status="detected",
        chebi="16411", kegg="C00954", pubchem="802",
        biospecimens=["Feces"], origins=["Endogenous"],
    ...
    dict(
        ...
        accession="HMDB0000020", name="Hippuric acid", status="quantified",
        chebi="18089", kegg="C01586", pubchem="464",
        biospecimens=["Feces", "Urine"], origins=["Food"],
    ...
    dict(
        ...
        accession="HMDB0000021", name="Formic acid", status="detected",
        chebi="30751", kegg="C00058", pubchem="284",
        biospecimens=["Feces"], origins=["Endogenous"],
    ...
    dict(
        ...
        accession="HMDB0000022", name="Lactic acid", status="quantified",
        chebi="78320", kegg="C00186", pubchem="612",
        biospecimens=["Feces"], origins=["Endogenous"],
        microbes={"Lactobacillus": []},
    ),
    dict(
        why="second of the collision pair: same chebi, different accession",
        accession="HMDB0000023", name="D-Lactic acid", status="detected",
        chebi="78320", kegg="C00256", pubchem="61503",
        biospecimens=["Feces"], origins=["Endogenous"], microbes={},
    ),
    dict(
        ...
        accession="HMDB0000024", name="Pyruvic acid", status="quantified",
        chebi="32816", kegg="c00022", pubchem="1060",
        biospecimens=["Feces"], origins=["Endogenous"], microbes={},
    ),
    dict(
        why="a kegg_id KEGG has withdrawn since HMDB 5.0 — reported, never "
            "silently dropped",
        accession="HMDB0000025", name="Withdrawn compound", status="expected",
        chebi="", kegg="C00626", pubchem="",
        biospecimens=["Feces"], origins=["Food"], microbes={},
    ),
    dict(
        why="the disease layer's dominant name, three times over: counted and "
            "not loaded",
        accession="HMDB0000026", name="Glutaric acid", status="quantified",
        chebi="17859", kegg="C00489", pubchem="743",
        biospecimens=["Feces", "Urine"], origins=["Endogenous"], microbes={},
        diseases=[(MEGA_DISEASE, ""), (MEGA_DISEASE, "250950"),
                  ("Colorectal cancer", "114500")],
    ),
    dict(
        why="a kegg_id of the `D` (drug) namespace, which cannot join a "
            "compound list at all",
        accession="HMDB0000027", name="A drug-namespace compound", status="expected",
        chebi="", kegg="D00109", pubchem="",
        biospecimens=["Feces"], origins=["Food"], microbes={},
    ),
    dict(
        why="no chebi at all, so the node is keyed on its HMDB accession",
        accession="HMDB0000028", name="Unmapped microbial metabolite",
        status="quantified", chebi="", kegg="", pubchem="",
        biospecimens=["Feces"], origins=["Endogenous"],
    ...
    dict(
        ...
        accession="HMDB0000029", name="Empty-element compound", status="detected",
        chebi=None, kegg=None, pubchem=None,
        biospecimens=["Feces"], origins=[], microbes={},
    ),
    dict(
        ...
        accession="HMDB0000031", name="Origin without an organism",
        status="quantified", chebi="", kegg="", pubchem="",
        biospecimens=["Blood"], origins=["Endogenous"], microbes={},
        bare_microbe=True,
    ),
    dict(
        ...
        accession="HMDB0000032", name="Homonym compound", status="quantified",
        chebi="", kegg="", pubchem="",
        biospecimens=["Feces"], origins=["Endogenous"],
        microbes={"Bacillus": []},
    ),
    dict(
        ...
        accession="HMDB0000030", name="Well-studied metabolite", status="quantified",
        chebi="16991", kegg="C00039", pubchem="6083",
        biospecimens=["Feces"], origins=["Endogenous"],
        microbes={"Blautia": []},
...
RECORDS += [
    dict(
        ...
        chebi="", kegg="", pubchem="",
        biospecimens=["Blood"] if i % 3 else [], origins=["Food"], microbes={},
    )
    for i in range(40)
]
