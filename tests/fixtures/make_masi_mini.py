...
MICROBE_HEADER = [
    "microbe_id", "microbe_tax_id", "microbe_name", "microbe_tax_level",
    "genus_id", "genus_name", "family_id", "family_name", "superking_id",
    "superking_name", "if_probiotic", "probiotic_use_species",
    "probiotic_research_stage", "if_has_abundance",
]

MICROBE_ROWS: list[list[str]] = [
    ["PMDBM1", "83334", "Escherichia coli O157:H7", "Strain", "561",
     "Escherichia", "543", "Enterobacteriaceae", "2", "Bacteria", "Yes",
     "Human", "Clinical trial", "Yes"],
    ["PMDBM2", "562", "Escherichia coli", "Species", "561", "Escherichia",
     "543", "Enterobacteriaceae", "2", "Bacteria", NA, NA, NA, "Yes"],
    ["PMDBM3", "818", "Bacteroides thetaiotaomicron", "Species", "816",
     "Bacteroides", "815", "Bacteroidaceae", "2", "Bacteria", NA, NA, NA, "Yes"],
    ["PMDBM4", NA, "Blautia spp.", "Species", "572511", "Blautia", "186803",
     "Lachnospiraceae", "2", "Bacteria", NA, NA, NA, "No"],
    ["PMDBM5", "976", "Bacteroidetes", "phylum", NA, NA, NA, NA, "2",
     "Bacteria", NA, NA, NA, "Yes"],
    ["PMDBM6", NA, "Unclassified gut microbiota", NA, NA, NA, NA, NA, NA, NA,
     NA, NA, NA, "No"],
    ["PMDBM7", "216816", "Bifidobacterium longum", "Species", "1678",
     "Bifidobacterium", "31953", "Bifidobacteriaceae", "2", "Bacteria", "Yes",
     "Animal", "Marketed", "Yes"],
]

SUBSTANCE_HEADER = [
    "Substance_id", "Substance_name", "Substance_category",
    "Substance_subcategory", "cas_no", "id_drugbank", "id_pharmgkb", "id_kegg",
    "id_ttd", "id_pubchem", "id_chemspider", "id_npass", "synonyms",
    "Molecular_formula", "inchikey", "iupacname", "Product_company",
    "Therapeutic_class",
]
...
SUBSTANCE_ROWS: list[tuple[str, str, str, str, str, str, str, str]] = [
    ("PMDBD1", "Metformin", "Therapeutic Substance", "Approved Drug",
     "657-24-9", "DB00331", "4091", "C4H11N5"),
    ("PMDBD2", "Ampicillin sodium", "Therapeutic substance",
     "Approved Drug; Antibiotics", "69-52-3", "DB00415", "23665617",
     "C16H18N3NaO4S"),
    ("PMDBD3", "ACE inhibitors", "Therapeutic Substance", "Drug Class", NA, NA,
     NA, NA),
    ("PMDBD4", "Baicalin", "Herbal Substance", "Medicinal Herbal Compounds",
     "21967-41-9", NA, "64982", "C21H18O11"),
    ("PMDBD5", "Aspirin", "Environmental Chemicals", "Unclassified Substance",
     "50-78-2", "DB00945", "2244", "C9H8O4"),
    ("PMDBD6", "Vancomycin", "Therapeutic Substance",
     "Approved Drug; Antibiotics", "1404-90-6", "DB00512", "14969", "C66H75Cl2N9O24"),
]

INTERACTION_HEADER = [
    # `Interation_Record_ID` is the real file's spelling, typo and all.
    "Interation_Record_ID", "Interaction_Category", "MASI-Microbe-ID",
    "Microbe-Tax-ID", "Microbe-Name", "MASI-Substance-chemicalD",
    "Substance-Name", "Substance-Category", "Substance-subCategory",
    "Substance_Exposure_Details", "Microbiota_Site", "Microbe_Change",
    "Microbe_Change_Statistics", "Metabolites", "Metabolism_Type",
    "Metabolism_Enzymes", "Metabolism_Effect_on_Drug", "Experiment_System",
    "Experiment_Model_Species", "Model_Condition/Disease",
    "Metabolism_Mechanism", "Outcome", "Reference_ID_Type", "Reference_ID",
]
...
INTERACTION_ROWS: list[dict[str, str]] = [
    {
        "Interation_Record_ID": "PMDBI1", "Interaction_Category": METABOLISM,
        "MASI-Microbe-ID": "PMDBM3", "Microbe-Tax-ID": "818",
        "Microbe-Name": "Bacteroides thetaiotaomicron",
        "MASI-Substance-chemicalD": "PMDBD6", "Substance-Name": "Vancomycin",
        "Substance-Category": "Therapeutic Substance",
        "Substance-subCategory": "Approved Drug; Antibiotics",
        "Metabolites": "vancomycin aglycone", "Metabolism_Type": "Hydrolysis",
        ...
        "Reference_ID_Type": "PMID", "Reference_ID": "PMID: 31158845",
    },
    {
        "Interation_Record_ID": "PMDBI2", "Interaction_Category": METABOLISM,
        "MASI-Microbe-ID": "PMDBM2", "Microbe-Tax-ID": "562",
    ...
    {
        "Interation_Record_ID": "PMDBI3", "Interaction_Category": METABOLISM,
        "MASI-Microbe-ID": "PMDBM6", "Microbe-Tax-ID": NA,
        "Microbe-Name": "Unclassified gut microbiota",
        "MASI-Substance-chemicalD": "PMDBD4", "Substance-Name": "Baicalin",
        "Substance-Category": "Herbal Substance",
        "Substance-subCategory": "Medicinal Herbal Compounds",
        "Metabolism_Effect_on_Drug": "Microbe does not metabolize drug",
        "Experiment_System": "In vitro", "Reference_ID_Type": "PMID",
        "Reference_ID": "PMID: 26569070",
    },
    {
        "Interation_Record_ID": "PMDBI4", "Interaction_Category": ABUNDANCE,
        "MASI-Microbe-ID": "PMDBM4", "Microbe-Tax-ID": NA,
        "Microbe-Name": "Blautia spp.",
        "MASI-Substance-chemicalD": "PMDBD1", "Substance-Name": "Metformin",
        "Substance-Category": "Therapeutic Substance",
        "Substance-subCategory": "Approved Drug",
        "Substance_Exposure_Details": "2 months of metformin treatment vs control",
        "Microbiota_Site": "Gut", "Microbe_Change": "Decrease",
        ...
        "Reference_ID_Type": "PMID", "Reference_ID": "PMID: 28530702",
    },
    {
        "Interation_Record_ID": "PMDBI5", "Interaction_Category": ABUNDANCE,
        "MASI-Microbe-ID": "PMDBM5", "Microbe-Tax-ID": "200643",
        "Microbe-Name": "Bacteroidetes",
        "MASI-Substance-chemicalD": "PMDBD1", "Substance-Name": "Metformin",
        "Substance-Category": "Therapeutic Substance",
        "Substance-subCategory": "Approved Drug",
        "Microbiota_Site": "Gut", "Microbe_Change": "Increase",
        "Experiment_System": "In vitro",
    ...
    {
        "Interation_Record_ID": "PMDBI6", "Interaction_Category": ABUNDANCE,
        "MASI-Microbe-ID": "PMDBM2", "Microbe-Tax-ID": "562",
        "Microbe-Name": "Escherichia coli",
        "MASI-Substance-chemicalD": "PMDBD5", "Substance-Name": "Aspirin",
        ...
        "Experiment_System": "In vitro",
        "Experiment_Model_Species": "High-throughput incubation assays",
        "Reference_ID_Type": "PMID", "Reference_ID": "PMID: 29555994",
    },
    {
        "Interation_Record_ID": "PMDBI7", "Interaction_Category": ABUNDANCE,
        "MASI-Microbe-ID": "PMDBM7", "Microbe-Tax-ID": "216816",
        "Microbe-Name": "Bifidobacterium longum",
        "MASI-Substance-chemicalD": "PMDBD4", "Substance-Name": "Baicalin",
        "Substance-Category": "Herbal Substance",
        "Substance-subCategory": "Medicinal Herbal Compounds",
        "Microbe_Change": "delay microbiota maturation",
        "Experiment_System": "In vivo", "Experiment_Model_Species": "Mouse",
        "Reference_ID_Type": "PMID", "Reference_ID": "PMID: 24033291",
    },
    {
        "Interation_Record_ID": "PMDBI8", "Interaction_Category": ABUNDANCE,
        "MASI-Microbe-ID": "PMDBM99", "Microbe-Tax-ID": NA,
        ...
        "Microbe_Change": "Decrease", "Experiment_System": "In vivo",
        "Experiment_Model_Species": "Human",
        "Reference_ID_Type": "PMID", "Reference_ID": "PMID: 32526207",
    },
    # One record id, two microbes — the shape 2,891 real rows have.
    {
        "Interation_Record_ID": "PMDBI9", "Interaction_Category": ABUNDANCE,
        "MASI-Microbe-ID": "PMDBM3", "Microbe-Tax-ID": "818",
        "Microbe-Name": "Bacteroides thetaiotaomicron",
        "MASI-Substance-chemicalD": "PMDBD5", "Substance-Name": "Aspirin",
        "Substance-Category": "Environmental Substance",
        "Substance-subCategory": "Unclassified Substance",
        "Microbe_Change": "Decrease", "Experiment_System": "In vitro",
        "Experiment_Model_Species": "High-throughput incubation assays",
        "Reference_ID_Type": "PMID", "Reference_ID": "PMID: 29555994",
    },
    {
        ...
        "Substance-Category": "Environmental Substance",
        "Substance-subCategory": "Unclassified Substance",
        "Microbe_Change": "Increase", "Experiment_System": "In vitro",
        "Experiment_Model_Species": "High-throughput incubation assays",
        "Reference_ID_Type": "PMID", "Reference_ID": "PMID: 29555994",
    },
    {
        "Interation_Record_ID": "PMDBI10", "Interaction_Category": ABUNDANCE,
        "MASI-Microbe-ID": "PMDBM3", "Microbe-Tax-ID": "818",
        "Microbe-Name": "Bacteroides thetaiotaomicron",
        "MASI-Substance-chemicalD": "PMDBD1", "Substance-Name": "Metformin",
        "Substance-Category": "Therapeutic Substance",
        "Substance-subCategory": "Approved Drug",
        "Microbe_Change": "Decrease", "Experiment_System": NA,
        "Experiment_Model_Species": "Human",
        "Reference_ID_Type": "PMID",
        "Reference_ID": "PMID: 28530702; PMID: 32409589",
    },
    {
        "Interation_Record_ID": "PMDBI11", "Interaction_Category": ABUNDANCE,
        "MASI-Microbe-ID": "PMDBM2", "Microbe-Tax-ID": "562",
        "Microbe-Name": "Escherichia coli",
        "MASI-Substance-chemicalD": "PMDBD1", "Substance-Name": "Metformin",
        "Substance-Category": "Therapeutic Substance",
        ...
        "Microbe_Change": "Increase", "Experiment_System": "In vitro",
        "Experiment_Model_Species": "High-throughput incubation assays",
        "Reference_ID_Type": "DOI", "Reference_ID": "; DOI: 10.1000/xyz123",
    },
    {
        "Interation_Record_ID": "PMDBI12", "Interaction_Category": METABOLISM,
        "MASI-Microbe-ID": "PMDBM3", "Microbe-Tax-ID": "818",
        "Microbe-Name": "Bacteroides thetaiotaomicron",
        "MASI-Substance-chemicalD": "PMDBD4", "Substance-Name": "Baicalin",
        "Substance-Category": "Herbal Substance",
        "Substance-subCategory": "Medicinal Herbal Compounds",
        "Metabolites": "Baicalein", "Metabolism_Type": "Hydrolysis",
        "Metabolism_Effect_on_Drug": "Increase Efficacy",
        "Experiment_System": "In vitro",
        "Reference_ID_Type": "PMID", "Reference_ID": "26569070",
    },
    {
...
DISEASE_HEADER = [
    "Association-record-ID", "Association-type", "MASI-Microbe-ID",
    "Microbe-Tax-ID", "Microbe-name", "Microbiota-site", "MASI-Disease-ID",
    "Disease-name", "Change-of-microbe", "Reference-type", "Reference-ID",
]
...
DISEASE_ROWS: list[tuple[str, ...]] = [
    ("PMDBDis1", "PMDBM3", "818", "Bacteroides thetaiotaomicron",
     "Gastrointestinal tract", "DIS1", "Colorectal cancer", "Decrease",
     "25079328"),
    # The same pair, the other way: two edges, never a verdict (G4).
    ("PMDBDis2", "PMDBM3", "818", "Bacteroides thetaiotaomicron",
     "Gastrointestinal tract", "DIS1", "Colorectal cancer", "Increase",
     "22043294"),
    ("PMDBDis3", "PMDBM2", "562", "Escherichia coli",
     "Gastrointestinal tract", "DIS2", "Obesity", "Increase", "28178201"),
    ("PMDBDis4", "PMDBM4", NA, "Blautia spp.", "Gastrointestinal tract",
     "DIS3", "Irritable bowel syndrome (IBS)", "Decrease", "28039159"),
    ("PMDBDis5", "PMDBM7", "216816", "Bifidobacterium longum",
     "Gastrointestinal tract", "DIS4", "Animal helminthiasis", "Decrease",
     "28179361"),
    ("PMDBDis6", "PMDBM5", "976", "Bacteroidetes", "Skin", "DIS5",
     "Rheumatoid arthrits", "Increase", "28195358"),
    # On the microbe that reaches no taxon: no edge, and the tombstone the
    # interaction table already wrote gains a second hit.
    ("PMDBDis7", "PMDBM6", NA, "Unclassified gut microbiota",
     "Gastrointestinal tract", "DIS1", "Colorectal cancer", "Decrease",
     "28279152"),
]
...
def main() -> None:
    ...
    write(
        OUT / FILES["substances"], SUBSTANCE_HEADER,
        [
            [sid, name, category, subcategory, cas, drugbank, NA, NA, NA,
             pubchem, NA, NA, name.lower(), formula, NA, NA, NA, NA]
            for sid, name, category, subcategory, cas, drugbank, pubchem,
            formula in SUBSTANCE_ROWS
        ],
    )
    write(
        OUT / FILES["interactions"], INTERACTION_HEADER,
        [[row.get(c, NA) for c in INTERACTION_HEADER] for row in INTERACTION_ROWS],
    )
    write(
        OUT / FILES["diseases"], DISEASE_HEADER,
        [
            [record, ASSOCIATION, microbe, tax_id, name, site, disease_id,
             label, change, "PMID", reference]
            for record, microbe, tax_id, name, site, disease_id, label, change,
            reference in DISEASE_ROWS
        ],
    )
    print(f"wrote {len(FILES)} workbooks to {OUT}: "
